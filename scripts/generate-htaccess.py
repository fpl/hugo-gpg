...
def main():
    ...
    out = [
        ...
        "",
        "# Pagina 404 tematizzata (layouts/404.html, generata da Hugo in",
        "# public/404.html). Percorso relativo alla webroot, non URL assoluto:",
        "# un URL assoluto qui trasformerebbe ogni 404 in un redirect 302 verso",
        "# quell'URL invece di restare un vero errore 404 -- la stessa classe di",
        "# problema del loop di redirect sulla root documentato più sotto.",
